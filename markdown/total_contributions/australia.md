...
The `public contributions` and `private contributions` by users in Australia on `2025/3/10 10:13 PM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.

There are `9 countries` and `68 cities` can be found [here](https://github.com/fdeniz07/top-github-users).

There are `947 users`  in Australia. You need at least `138 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/cpmech">
				<img src="https://avatars.githubusercontent.com/u/9506388?s=72&u=a75f1103072efdf662841845951000f360900162&v=4" width="24" alt="Avatar of cpmech"> cpmech
			</a><br/>
			Dr Dorival Pedroso
		</td>
