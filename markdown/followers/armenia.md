...
The `number of followers` of users in Armenia on `2024/4/14 9:08 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
