...
The `number of followers` of users in Armenia on `2024/1/24 4:22 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/BUGOVER">
				<img src="https://avatars.githubusercontent.com/u/22304644?s=72&v=4" width="24" alt="Avatar of BUGOVER"> BUGOVER
			</a><br/>
			Artak
		</td>
		<td>Nativeteams </td>
