...
The `number of followers` of users in Austria on `2025/3/22 4:12 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
...
<table>
	...
	<tr>
		...
		<td>Mostly Ai </td>
		<td><a href="https://twitter.com/michael_platzer">michael_platzer</a></td>
		<td>Vienna, Austria</td>
		<td>49</td>
	</tr>
	<tr>
