...
The `number of followers` of users in Austria on `2025/1/10 6:14 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `9 countries` and `68 cities` can be found [here](https://github.com/fdeniz07/top-github-users).

There are `945 users`  in Austria. You need at least `47 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/salykova">
				<img src="https://avatars.githubusercontent.com/u/63703454?s=72&u=ebf5e678d789a18d4b0a57033b8f1d6ba7eb206b&v=4" width="24" alt="Avatar of salykova"> salykova
			</a><br/>
			Aman Salykov
		</td>
		<td>No Company</td>
