...
The `number of followers` of users in Afghanistan on `2024/2/28 10:16 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `9 countries` and `68 cities` can be found [here](https://github.com/fdeniz07/top-github-users).

There are `895 users`  in Afghanistan. You need at least `1 followers` to be on this list.
