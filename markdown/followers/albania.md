...
The `number of followers` of users in Albania on `2024/11/17 7:09 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/_andibeqiri_">_andibeqiri_</a></td>
		<td>Albania</td>
		<td>2</td>
	</tr>
	<tr>
